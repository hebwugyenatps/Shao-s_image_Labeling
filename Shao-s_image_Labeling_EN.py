...
# --- Custom Image Viewer (Unchanged logic) ---
...
class AppWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Shao's Labeling Tool")
    ...
    def setup_ui(self):
        ...
        # Top Toolbar
        top_bar = QHBoxLayout()
        self.lbl_info = QLabel("Please load a folder or drag & drop images to the left.")
        ...
        self.text_edit.setPlaceholderText("Text content will appear here...")
        ...
        self.btn_prev = QPushButton("A Previous")
        self.btn_prev.setShortcut("a") 
        
        # Function Buttons
        self.btn_sys_open = QPushButton("🖥️ System Open")
        ...
        self.btn_save = QPushButton("Ctrl+S Save Text")
        self.btn_save.setShortcut("Ctrl+S")
        
        self.btn_next = QPushButton("D Next")
    ...
    def copy_image_to_clipboard(self):
        ...
        if not pixmap.isNull():
            ...
            self.setWindowTitle(original_title + " [Image Copied!]")
            from PyQt6.QtCore import QTimer
            QTimer.singleShot(1000, lambda: self.setWindowTitle(original_title))
        else:
            QMessageBox.warning(self, "Tip", "No valid image loaded, cannot copy.")
    ...
    def update_char_count(self):
        ...
        count = len(text)
        self.lbl_char_count.setText(f"Chars: {count}")
    ...
    def load_folder_images(self, folder_path):
        ...
        if not self.image_files:
            QMessageBox.warning(self, "Warning", "No image files found in this directory.")
            return
    ...
    def navigate(self, step):
        ...
        if 0 <= new_index < len(self.image_files):
            ...
            msg = "Already at the first image" if step < 0 else "Already at the last image"
            print(msg)
    ...
    def load_pair(self, index):
        ...
        self.lbl_info.setText(f"Current File [{index+1}/{len(self.image_files)}]: {filename}")
        self.setWindowTitle(f"Shao's Labeling Tool - Editing: {filename}")
    ...
    def save_current_text(self):
        ...
        try:
            with open(self.current_txt_path, 'w', encoding='utf-8') as f:
                f.write(content)
            print(f"Saved: {self.current_txt_path}")
        except Exception as e:
